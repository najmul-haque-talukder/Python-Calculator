...
for text, column, row in buttons:
    ...
    tk.Button(root, text=text, font=("Arial", 18), command=action, width=5, height=2).grid(column=column, row = row)


tk.Button(root, text="AC", font=("Arial", 18), command=clear, width=5, height=2 ).grid(column=column, row=5, columnspan=4)
